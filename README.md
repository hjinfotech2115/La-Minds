...
| **Backend** | [Language, e.g., Python, Node.js, PHP], [Framework, e.g., Django, Express, Spring] |
| **Databases** | [e.g., PostgreSQL, MongoDB, MySQL, Firebase] |
| **DevOps/Cloud** | [e.g., Docker, AWS, Azure, CI/CD, Git] |
